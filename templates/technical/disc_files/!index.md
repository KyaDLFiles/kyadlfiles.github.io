...
***1!Pictures for all sectors are available!* [here](./sector_pictures).**
...
|8|!{!2}Partial|Area with the bird and very beginning of the slide, connecting sectors 3 and 4|||
...
|13|!{!2}Partial|Very end of the slide, connecting sectors 10 and 4|||
...
|4|!{!1}Area|First part of the cave going to Brazul's laboratory, up until the freefall section<br>Has a nodraw backdrop|9, 14|-|
...
|!{+!4}10|!{!2}Partial|Unused, lefover from prototype builds<br>Earlier version of the tunnel supposed to connect sectors 13 and 6, but in the final game the tunnel is part of sector 13 (and LEVEL_11) and looks very different||||
|11|!{!2}Partial|Very beginning of the slide, connecting sectors 3 and 5|||
|12|!{!2}Partial|Elevator shaft at the start of the level<br>Notably not used to connect two different sectors|||
|13|!{!1}Area|Second part of the cave going to Brazul's laboratory, freefall section (except the very beginning)<br>Has a nodraw backdrop|14|-||
|14|!{!2}Partial|Very beginning of the freefall section, connecting sectors 4 and 13<br>Has a nodraw backdrop|N/A|N/A|
...
|!{+!4}7|!{!3}?|Unused, leftover from prototype builds<br>Original purpose unknown, all that remains in the final build is a single rectangular-ish model with a reflection effect|N/A|N/A|
...
|!{+!4}17|!{!2}Partial|Unused, leftover from prototype builds<br>Beginning and end of the scrapped path, connecting sectors 2 and 9|||
